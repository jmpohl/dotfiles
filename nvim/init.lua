...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {
      ...
      spec = {
        ...
        { 'gl', group = '[L]anguage Service Protocol', mode = { 'n', 'v' } },
      },
    },
  },
  {
  ...
  },
  {
    ...
    config = function()
      ...
      dap.adapters.lldb = {
        type = 'executable',
        command = '/usr/lib/llvm-15/bin/lldb-vscode',
        name = 'lldb',
      }
      ...
      vim.keymap.set('n', '<F5>', '<cmd>RustLsp debuggables<CR>', { desc = 'Start Debugging' })
      ...
      local function set_debug_keymaps()
        ...
        vim.keymap.set('n', '<leader>dk', dap.up, { desc = 'Stack Frame Up' })
        vim.keymap.set('n', '<leader>dj', dap.down, { desc = 'Stack Frame Down' })
      end

      local function clear_debug_keymaps()
        local keys = { '<F10>', '<F11>', '<S-F11>', '<F5>', '<S-F5>', '<leader>dr', '<leader>dl', '<leader>dk', '<leader>dj' }
     ...
     dap.listeners.before.event_terminated['me'] = shutdown
      dap.listeners.before.event_exited['me'] = shutdown
    end,
  },
  {
